...
Implementing this as a simple check whether jerk < 0 or jerk > 0 leads to intense flickering at rest, and occasionally even some flickering in the middle of the arc of the wand. In order to reduce the flickering, a moving average can be applied over N frames to acquire a smoother "direction" value.

### Moving average

With a moving average of 5, the performance of the wand was slightly delayed. With a moving average of 50, the detected direction of the wand and the actual direction of the wand was almost exactly 90 degrees out of phase. 
